...
const UserPassReset = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`https://dresscolorsuggestion-backend-sefa.onrender.com/api/user/reset-password/${token}`, { password: newPassword });
    ...
    return (
        <div className="container-fluid reset d-flex justify-content-center align-items-center" style={{ height: '100vh' }}>
